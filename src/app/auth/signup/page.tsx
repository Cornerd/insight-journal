/**
 * Sign Up Page
 * Create a new account using OAuth providers
 */
...
export default function SignUpPage() {
  ...
  const handleOAuthSignUp = async (provider: 'github' | 'google') => {
    ...
    try {
      ...
      setError(`Failed to create account with ${provider}. Please try again.`);
      setIsLoading(false);
    }
  };
            ...
            <div className='flex'>
              ...
              <div className='ml-3'>
                ...
                <div className='mt-2 text-sm text-blue-700'>
                  <p>
                    Create your account instantly using your existing GitHub or
                    Google account. No passwords to remember, and your data
                    stays secure.
                  </p>
                </div>
              </div>
