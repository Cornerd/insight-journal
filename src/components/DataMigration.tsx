...
import { isEntryMigrated, isContentMigrated, clearMigrationTracker, getMigrationStats } from '@/utils/migrationTracker';
...
export function DataMigration() {
  ...
  if (entriesToMigrate.length === 0 && !migrationResult && migrationStats.totalMigrated === 0) {
    return null;
  }
            ...
            <div className="space-y-3">
              <p className="text-sm text-blue-700">
                ...
                {entriesToMigrate.length > 0 ? (
                  <>
                    {' '}<strong>{entriesToMigrate.length}</strong> entries can be migrated to cloud storage.
                  </>
                ) : (
              ...
              <div className={`p-3 rounded-md ${
                ...
                <div className={`text-xs mt-2 space-y-1 ${
                  ...
                  {migrationResult.skippedCount > 0 && (
                    <p>Skipped: {migrationResult.skippedCount} entries (already in cloud)</p>
                  )}
